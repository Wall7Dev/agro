  ...
  return (<>
    <main className={styles.aboutus} id="6-aboutsUs-pageMain">
            ...
            <div className={styles.logoasset}>
              <button className={styles.arrowframe}>
                <div className={styles.oursubsidiarylogos} id="ourSubsidiaries">
                  ...
                  <img className={styles.clipPathGroup1} alt="" src="/clip-path-group2@2x.png" onClick={onClipPathGroup1Click} />
                  <img className={styles.clipPathGroup2} alt="" src="/clip-path-group4@2x.png" onClick={onClipPathGroup2Click} />
                  <img className={styles.oursubsidiarylogosChild} alt="" src="/group-93911.svg" />
                </div>
                <img className={styles.images21} alt="" src="/images-2-11@2x.png" />
              </button>
              <div className={styles.lgoframe} onClick={onLgoFrameContainerClick}>
                <img className={styles.logoIcon} id="logo" alt="" src="/logo1@2x.png" />
              </div>
            </div>
      ...
      <section className={styles.herosec} id="aboutUs_herosection">
        <div className={styles.weAreTransformingAfricanAgWrapper} data-animate-on-scroll>
          <div className={styles.weAreTransformingContainer} data-animate-on-scroll>
            ...
            <p className={styles.weAreTransforming}>
              ...
              <span className={styles.africanAgricultureOne}>  African agriculture, one innovation</span>
            </p>
            <p className={styles.atATime}>{` at a time. `}</p>
          </div>
        </div>
      </section><Container /><Leading /><LeaderSections /><ContainerOurSubsidiar /><FOOTERCOMPONENT2 />
    </main>
{isDrwawerMenuOpen && (
            <PortalDrawer
