    ...
    <main className={styles.contactus}>
          ...
          <div className={styles.logorightnavlink}>
            <div className={styles.logoasset}>
              <button className={styles.arrowframe}>
                <div className={styles.oursubsidiarylogos} id="ourSubsidiaries">
                  ...
                  <img className={styles.clipPathGroup1} alt="" src="/clip-path-group11@2x.png" onClick={onClipPathGroup1Click} />
                  <img className={styles.clipPathGroup2} alt="" src="/clip-path-group12@2x.png" onClick={onClipPathGroup2Click} />
              ...
              <div className={styles.lgoframe} onClick={onLgoFrameContainerClick}>
                <img className={styles.logoIcon} id="logo" alt="" src="/logo5@2x.png" />
              </div>
            </div>
            <nav className={styles.rightnavlink}>
              ...
              <button className={styles.contactusContainer} onClick={onContactUsContainerClick}>
                ...
                <img className={styles.contactusContainerChild} alt="" src="/line-117@2x.png" />
              </button>
            </nav>
          </div>
        </nav>
      ...
      <div className={styles.formsHero}>
        <section className={styles.workwithframe}>
          <section className={styles.frameParent}><FrameComponent4 /><CONTACTFORM />
          </section>
        </section>
      </div>
      <div className={styles.outTeam}>
        <div className={styles.dktpTeamFaqCta}>
          <img className={styles.dktpTeamFaqCtaChild} alt="" src="/vector-211@2x.png" />
          ...
          <div className={styles.cardgropupo} data-animate-on-scroll>
            <div className={styles.xorse}>
              <div className={styles.xoseAhlijaTeam}>
                <img className={styles.baseIcon} alt="" src="/base22@2x.png" />
          ...
          <div className={styles.cta}>
            <div className={styles.gradientmsgWrapper}>
              <div className={styles.gradientmsg}>
                <img className={styles.gradientmsgChild} alt="" src="/group-20611@2x.png" data-animate-on-scroll />
                <div className={styles.weSupportAgribusinessIndustParent}>
                  <b className={styles.weSupportAgribusinessContainer} data-animate-on-scroll>
                    <p className={styles.weSupportAgribusiness}>{`We support Agribusiness Industry To Utilize modern Equipments `}</p>
                    <p className={styles.weSupportAgribusiness}>for a Better Result.</p>
                  </b>
                  <div className={styles.vectorParent} onClick={onFrameContainerClick}>
                    <img className={styles.frameChild} alt="" src="/arrow-9.svg" onClick={onArrowIconClick} />
            ...
            <div className={styles.faq}>
              <div className={styles.frequently}>
                ...
                <b className={styles.frequentlyAskedQueContainer}>
                  <p className={styles.weSupportAgribusiness}>{`Frequently `}</p>
                  <p className={styles.weSupportAgribusiness}>Asked Questions</p>
                </b>
                <div className={styles.allowsOrganizations}>
                  <p className={styles.weSupportAgribusiness}>{`Browse through our mostly asked questions and `}</p>
                  <p className={styles.weSupportAgribusiness}>enquiries for fast response.</p>
                </div>
              </div>
            </div>
              ...
              <div className={styles.faq11}>
                ...
                <div className={styles.poppup1}>
                  <div className={styles.whatDoesTheContainer}>
                    ...
                    <p className={styles.weOfferA}>We offer a comprehensive suite of agriculturally inclined digitalsolutions. Use the contact us button at the button of the site to reach us.</p>
                  </div>
                </div>
              </div>
              ...
              <div className={styles.faq3}>
                ...
                <div className={styles.poppup2}>
                  <div className={styles.whatDoesTheContainer}>
                    ...
                    <p className={styles.weOfferA}>Agrospectrum Limited is a for-profit entity that provides Agric business enterprises with top notch digital solutions.</p>
                  </div>
                </div>
              </div>
              <div className={styles.faq4}>
                ...
                <div className={styles.poppup4}>
                  <div className={styles.whatAreSomeContainer}>
                    ...
                    <p className={styles.weOfferA2}>{`We offer a comprehensive suite of digital solutions `}</p>
                    <p className={styles.weSupportAgribusiness}>{`We are proud to let you know our diligence and hardwork has paid greatly. MOFA, YARA, IGNITIA, MAY & LOTTE , SMG Agro, Agromite, ISDA, SESI technologies are few of the prominent partners that we deal with.`}</p>
                  </div>
                </div>
              </div>
              <div className={styles.faq5}>
                ...
                <div className={styles.poppup2}>
                  <div className={styles.whatDoesTheContainer}>
                    ...
                    <p className={styles.weOfferA}>With Agrospectrum’s solutions your business gets to maximize profit and increase productivity. Farmers can have access to a wide array of extension, agronomic information, climate smart advice and certification that will allow their produce break into global markets.</p>
                  </div>
                </div>
              </div>
            </div>
