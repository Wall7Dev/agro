            ...
            <div className={styles.logoasset}>
              <button className={styles.arrowframe}>
                <div className={styles.oursubsidiarylogos} id="ourSubsidiaries">
                  ...
                  <img className={styles.clipPathGroup1} alt="" src="/clip-path-group9@2x.png" onClick={onClipPathGroup1Click} />
                  <img className={styles.clipPathGroup2} alt="" src="/clip-path-group10@2x.png" onClick={onClipPathGroup2Click} />
                  <img className={styles.oursubsidiarylogosChild} alt="" src="/group-93911.svg" />
                </div>
                <img className={styles.images21} alt="" src="/images-2-14@2x.png" />
              </button>
              <div className={styles.lgoframe} onClick={onLgoFrameContainerClick}>
                <img className={styles.logoIcon} id="logo" alt="" src="/logo4@2x.png" />
              </div>
            </div>
            <nav className={styles.rightnavlink}>
              <div className={styles.homecParent}>
                ...
                <button className={styles.clientspartners} onClick={onClientspartnersClick}>
                  ...
                  <img className={styles.clientspartnersChild} alt="" src="/line-1@2x.png" />
                </button>
        ...
        <div className={styles.ourprojectframeParent}>
          <div className={styles.ourprojectframe}>
            <div className={styles.mofaColorWrapper}>
              ...
              <div className={styles.theNationssBest}>The nations’s best digital Agric Platform</div>
            </div>
            <div className={styles.frameParent}>
              <div className={styles.eSubsidiaryParent}>
                <div className={styles.eSubsidiary}>
                  ...
                  <img className={styles.baseIcon} alt="" src="/base16@2x.png" />
                  <div className={styles.aFlagshipProgram}>A flagship program of the MoFA(Ghana) that used Agrospectrum’s mobile application provide input Subsidy to farmers.</div>
                ...
                <div className={styles.inputCredit}>
                  <div className={styles.eSubsidiary}>
                    ...
                    <img className={styles.baseIcon} alt="" src="/base17@2x.png" />
                    <div className={styles.aCreditProgramContainer}>
                      <span className={styles.aCreditProgram}>{`A credit program spearheaded by `}</span>
                      <span className={styles.mayAndLotte}>May and Lotte,</span>
                      <span className={styles.aCreditProgram}> leveraged our cutting-edge solutions at the crucial redemption stage for a streamlined process.</span>
                    </div>
                    <div className={styles.groupWrapper}>
                      <div className={styles.block1Group}>
                        ...
                        <div className={styles.inputCreditMgt}>{`Input Credit Mgt. `}</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className={styles.farmerKycParent}>
                <div className={styles.eSubsidiary}>
                  ...
                  <img className={styles.baseIcon2} alt="" src="/base18@2x.png" />
                  <div className={styles.imagineAFuture}>{`Imagine a future of digitization of the agribusiness were reliable technology become your allies for informed decision making `}</div>
                  <div className={styles.farmerKycInner}>
                    <div className={styles.block1Parent}>
                      <div className={styles.block1Parent}>
                        <div className={styles.rectangle} />
                      </div>
                      <div className={styles.farmerKyc1}>FARMER KYC</div>
                    </div>
                  </div>
                </div>
                <div className={styles.aggregation}>
                  <div className={styles.eSubsidiary}>
                    ...
                    <img className={styles.baseIcon} alt="" src="/base19@2x.png" />
                    <div className={styles.runByOurContainer}>
                      <p className={styles.runByOurClientsMayAndLot}>
                          <span className={styles.runByOur}>{`Run by our clients `}</span>
                            <span className={styles.mayAndLotte1}>May and Lotte,</span>
                        <span className={styles.aCreditProgram}> employed solutions from Agrospectum to streamline purchases and payments for the aggregated commodities.</span>
                      </p>
                    </div>
                    <div className={styles.groupContainer}>
                      <div className={styles.groupDiv}>
                        ...
                        <div className={styles.aggregationProgram}>Aggregation Program</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className={styles.farmerKycParent}>
                <div className={styles.eSubsidiary}>
                  ...
                  <img className={styles.baseIcon} alt="" src="/base20@2x.png" />
                  <div className={styles.anEnumerationProgram}>An enumeration program by the Government of Ghana through the Ministry of Food and Agriculture that profiles farmers for inclusion.</div>
                  <div className={styles.farmerRregistrationInner}>
                    <div className={styles.frameWrapper}>
                      <div className={styles.farmerRegistrationWrapper}>
                        <div className={styles.farmerRegistration}>{`Farmer Registration   `}</div>
                      </div>
                    </div>
                  </div>
                </div>
                <div className={styles.eSubsidiary}>
                  ...
                  <img className={styles.baseIcon} alt="" src="/base21@2x.png" />
                  <div className={styles.ourClimateSmartSolution}>{`Our climate-smart solution empowers farmers across languages with vital information like weather forecasts, disaster preparedness & agro-advice.`}</div>
                  <div className={styles.climateSmartProgramInner}>
                    <div className={styles.block1Parent1}>
                      <div className={styles.block1Parent1}>
                        <div className={styles.rectangle4} />
                      </div>
                      <div className={styles.climateSmartProgram1}>Climate Smart Program</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className={styles.projectArrow}>
              <img className={styles.projectArrowChild} alt="" src="/frame-12101@2x.png" />
              ...
              <div className={styles.frameGroup} data-animate-on-scroll>
                <div className={styles.frameDiv}>
                  <section className={styles.download5Parent}>
                    <img className={styles.download5Icon} alt="" src="/download-522@2x.png" />
                    <img className={styles.download3Icon} alt="" src="/download-311@2x.png" />
                  </section>
                  <section className={styles.captureParent}>
                    <img className={styles.captureIcon} alt="" src="/capture11@2x.png" />
                    <img className={styles.download6Icon} alt="" src="/download-612@2x.png" />
                  </section>
                </div>
                <section className={styles.frameSection}>
                  <section className={styles.download5Group}>
                    <img className={styles.download5Icon1} alt="" src="/download-5@2x.png" />
                    <img className={styles.download2Icon} alt="" src="/download-211@2x.png" />
                    <img className={styles.ignitiaLogo1Icon} alt="" src="/ignitialogo-11@2x.png" />
                  </section>
                  <section className={styles.download1Parent}>
                    <img className={styles.download1Icon} alt="" src="/download-111@2x.png" />
                    <img className={styles.images1Icon} alt="" src="/images-111@2x.png" />
                    <div className={styles.agromiteParent}>
                      <div className={styles.agromite}>AGROMITE</div>
                      <img className={styles.downloadIcon} alt="" src="/download11@2x.png" />
                    </div>
                  </section>
                </section>
                <section className={styles.mofaColorWrapper}>
                  <img className={styles.mofaColorIcon} alt="" src="/mofa-color11@2x.png" />
                </section>
              </div>
            </section>
          </div>
        ...
        <div className={styles.component1}>
          <div className={styles.frameParent1}>
            <div className={styles.download5Container}>
              <img className={styles.download5Icon2} alt="" src="/download-524@2x.png" />
              <img className={styles.download5Icon3} alt="" src="/download-525@2x.png" />
              <img className={styles.captureIcon1} alt="" src="/capture12@2x.png" />
              <img className={styles.mofaColorIcon1} alt="" src="/mofa-color12@2x.png" />
              <img className={styles.download3Icon1} alt="" src="/download-312@2x.png" />
              <img className={styles.imagesIcon} alt="" src="/images10@2x.png" />
              <img className={styles.download6Icon1} alt="" src="/download-613@2x.png" />
              <img className={styles.download1Icon1} alt="" src="/download-112@2x.png" />
              <img className={styles.downloadIcon1} alt="" src="/download12@2x.png" />
              <img className={styles.images1Icon1} alt="" src="/images-112@2x.png" />
              <img className={styles.download2Icon1} alt="" src="/download-212@2x.png" />
            </div>
            <div className={styles.download5Parent1}>
              <img className={styles.download5Icon2} alt="" src="/download-526@2x.png" />
              <img className={styles.download5Icon3} alt="" src="/download-527@2x.png" />
              <img className={styles.captureIcon1} alt="" src="/capture13@2x.png" />
              <img className={styles.mofaColorIcon1} alt="" src="/mofa-color13@2x.png" />
              <img className={styles.download3Icon1} alt="" src="/download-313@2x.png" />
              <img className={styles.imagesIcon} alt="" src="/images11@2x.png" />
              <img className={styles.download6Icon1} alt="" src="/download-614@2x.png" />
              <img className={styles.download1Icon1} alt="" src="/download-113@2x.png" />
              <img className={styles.downloadIcon1} alt="" src="/download13@2x.png" />
              <img className={styles.images1Icon1} alt="" src="/images-113@2x.png" />
              <img className={styles.download2Icon1} alt="" src="/download-213@2x.png" />
            </div>
          </div>
        </div>
          ...
          <div className={styles.transformParent} id="footercontent" data-animate-on-scroll>
            <div className={styles.transform}>
              ...
              <div className={styles.nuncUltricesTellusWrapper}>
                <div className={styles.nuncUltricesTellusContainer}>
                  <p className={styles.runByOurClientsMayAndLot}>{`Transform your agricultural practices and `}</p>
                  <p className={styles.runByOurClientsMayAndLot}>
                ...
                <div className={styles.nowWereParent}>
                  ...
                  <div className={styles.frameParent4}>
                    ...
                    <div className={styles.nowWereGroup} onClick={onFrameContainer3Click}>
                      ...
                      <img className={styles.frameChild} alt="" src="/line-110@2x.png" />
                    </div>
                  </div>
                </div>
            ...
            <div className={styles.frameParent8}>
              <button className={styles.vectorParent}>
                <img className={styles.frameItem} alt="" src="/arrow-104.svg" onClick={onArrowIconClick} />
