          ...
          <div className={styles.logorightnavlink}>
            <div className={styles.logoasset}>
              ...
              <div className={styles.lgoframe} onClick={onLgoFrameContainerClick}>
                <img className={styles.logoIcon} id="logo" alt="" src="/logo11@2x.png" />
              </div>
            </div>
      ...
      <section className={styles.section6partners}>
        ...
        <div className={styles.mayAndLotteInternationalPaParent}>
          <div className={styles.mayAndLotteContainer}>
            ...
            <span className={styles.ayAnd}>{`OTTE INTERNATIONAL PARTNERS `}</span>
        ...
        <div className={styles.mayAndLotteContainer1}>
          <p className={styles.mayAndLotte}>May and Lotte International; a Ghanaian agricultural company has partnered with agritech industry leader, Agrospectrum Limited to impact the country’s agricultural industry with its Input credit and Aggregation programs respectively in Northern Ghana.</p>
          <p className={styles.theProgramsThat}>{`The programs that are primarily been run in the five Northern regions aim to use Agrospectrum Limited’s groundbreaking solutions to digitalize May and Lotte’s business functions in the bid to promote inclusivity in terms of access to finances, inputs, and markets.  The Input-credit program which is currently in the collection stage began earlier in the year at the start of the farming season leveraging `}</p>
          <p className={styles.mayAndLotte}>&nbsp;</p>
          <p className={styles.theProgramsThat}>Agrospectrum Limited’s technology to provide farmers with inputs, monitoring services, and insights into their expected returns and payment terms.  Currently, at the collection stage, Agrospectrum limited is facilitating the collection of the commodities and ensuring the quality by using an Internet of Things (IoT) system to ensure that the commodities collected meet the weight and moisture content requirements of the client. A total of 174 farmers benefited from this years input-credit program.</p>
          <p className={styles.mayAndLotte}></p>
          <p className={styles.theProgramsThat}>{`In the ongoing aggregation program also being run by the former, Agrospectrum Limited’s cutting–edge solution is employed to enact a seamless framework in the aggregation procedure. Features of the Aggregation solution like the special tag system attached to the bags and the direct payments into farmers’ mobile money wallets for the various networks are de-risking the agricultural processes from farm to table.  `}</p>
          <p className={styles.mayAndLotte}>&nbsp;</p>
          <p className={styles.mayAndLotte}>The Internet of Things (IoT) system is also employed here to ensure that both farmers and aggregators get absolute benefits. Agrospectrum limited’s solution intelligently pegs the market rate of the commodity to the weight of the bags being collected to sanitize the aggregation process and ensure equity. </p>
          <p className={styles.mayAndLotte}></p>
          <p className={styles.mayAndLotte}>About Agrospectrum Limited:</p>
          <p className={styles.mayAndLotte}>{`Agrospectrum Limited is not only a facilitator of transactions; it is a driving force for positive change. The company’s commitment to transforming the agricultural sector is evident in its holistic approach to promoting sustainable and climate-smart agriculture. `}</p>
          <p className={styles.mayAndLotte}>&nbsp;</p>
          <p className={styles.mayAndLotte}>Agrospectrum Limited guarantees that its services reach a broad audience by utilizing various communication methods such as SMS and voice communications.</p>
          <p className={styles.mayAndLotte}>As a game-changer business entity, Agrospectrum continues to introduce new technological solutions that can compete on a global scale and is dedicated to producing innovative solutions that will shift paradigms in the Agricultural industry in sub-Saharan Africa.</p>
          <p className={styles.mayAndLotte}></p>
          <p className={styles.mayAndLotte}>Media Contact:</p>
          <p className={styles.theProgramsThat}>
            <b>Audrey A. Oduro</b>
          </p>
          <p className={styles.mayAndLotte}>a.oduro@bsl.com.gh</p>
        </div>
          ...
          <div className={styles.gradientmsg}>
            ...
            <div className={styles.weSupportAgribusinessIndustParent}>
              <b className={styles.weSupportAgribusinessContainer} data-animate-on-scroll>
                <p className={styles.mayAndLotte}>We support Agribusiness Industry</p>
                <p className={styles.mayAndLotte}>To Utilize modern Equipments</p>
        ...
        <div className={styles.arrow}>
          <div className={styles.navRightsvgFill} onClick={onNavRightsvgFillContainerClick}>
            ...
            <img className={styles.path2Icon} alt="" src="/path-25.svg" onClick={onPath2IconClick} />
          </div>
          ...
          <div className={styles.navRightsvgFill1}>
            <img className={styles.vectorIcon1} alt="" src="/vector21.svg" onClick={onVectorIconClick} />
            <img className={styles.path2Icon1} alt="" src="/path-26.svg" onClick={onPath2Icon2Click} />
          </div>
        </div>
      </section>
        ...
        <div className={styles.component1}>
          <div className={styles.frameGroup}>
            <div className={styles.download5Parent}>
              ...
              <img className={styles.download6Icon1} alt="" src="/download-6@2x.png" />
            ...
            <div className={styles.transform}>
              ...
              <div className={styles.nuncUltricesTellusWrapper}>
                <div className={styles.nuncUltricesTellusContainer}>
                  <p className={styles.mayAndLotte}>{`Transform your agricultural practices and `}</p>
                  <p className={styles.mayAndLotte}>
