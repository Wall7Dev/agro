...
useEffect(() => {
  ...
  return (<>
    <main className={styles.agriculturalResilience} id={`7projects&partermain`}>
          ...
          <div className={styles.logorightnavlink}>
            <div className={styles.logoasset}>
              ...
              <div className={styles.lgoframe} onClick={onLgoFrameContainerClick}>
                <img className={styles.logoIcon} id="logo" alt="" src="/logo8@2x.png" />
              </div>
            </div>
      ...
      <section className={styles.section6partners}>
        ...
        <div className={styles.enhancingAgriculturalResilieParent}>
          <div className={styles.enhancingAgriculturalResilieContainer}>
            ...
            <span className={styles.nhancing}>{`GRICULTURAL RESILIENCE THROUGH `}</span>
            <span className={styles.e}>I</span>
            <span className={styles.nhancing}>GNITIA’S CLIMATE MONITORING.</span>
          </div>
        ...
        <div className={styles.agrospectrumLimitedAContainer}>
          <p className={styles.agrospectrumLimitedA}>Agrospectrum Limited, a platform solution that aggregates data of all the Agric Value chain actors in Ghana is partnering with Ignitia to aid farmers with weather information.</p>
          <p className={styles.agrospectrumLimitedA}>In an era of rising climate concerns, the Agricultural sector is likely to suffer most as climate change adversely affects its output. This strategic partnership is aimed at ensuring farmers are armed with enough information that allows them to cope and survive in the harshest of climate situations</p>
          <p className={styles.agrospectrumLimitedA}>&nbsp;</p>
          <p className={styles.agrospectrumLimitedA}>&nbsp;</p>
          <p className={styles.agrospectrumLimitedA}>&nbsp;</p>
          <p className={styles.agrospectrumLimitedA}>Ignitia, is a tropical weather forecasting company, and its partners as part of efforts to address the climate crisis in the continent have introduced a climate intelligence solution to give accurate weather forecasts ranging from 48-hour rainfall forecasts to monthly and seasonal predictions.</p>
          <p className={styles.agrospectrumLimitedA}>&nbsp;</p>
          <p className={styles.agrospectrumLimitedA}>The partnership is expected to enhance Agricultural Resilience through Climate Monitoring with the aid of Data Analytics and educate the farmers on how digitalization connects them to global opportunities.</p>
          <p className={styles.agrospectrumLimitedA}>Ignitia is a third-party agency that provides climatic information, hence Agrospectrum is partnering with them to provide that service as part of our solutions.</p>
          <p className={styles.agrospectrumLimitedA}>&nbsp;</p>
          <p className={styles.agrospectrumLimitedA}> At Agrospectrum, climate technology is not part of our mandate, but it's a good mix to infuse in our solutions and so in order not to divert, we are teaming up with an entity like Ignitia with such capacity.</p>
          <p className={styles.agrospectrumLimitedA}>&nbsp;</p>
          <p className={styles.agrospectrumLimitedA}> Additionally, we will also introduce an Interactive Voice Response (IVR) that currently runs in nine Ghanaian local languages, French and English with plans to expand.</p>
          <p className={styles.agrospectrumLimitedA}>&nbsp;</p>
          <p className={styles.agrospectrumLimitedA}>{`This technology will allow telephone users to interact with a computer-operated telephone system through voice and Dual Tone Multi Frequency (DTMF) tones that would route them to our call centers. It can also be used for various purposes, such as customer service, healthcare, education, and finance. `}</p>
          <p className={styles.agrospectrumLimitedA}>&nbsp;</p>
          <p className={styles.agrospectrumLimitedA}>As farmers lack access to the requisite information; It is the expectation of Agrospectrum that, this integration would go a long way to impact lives and economy. Especially, that of farmers while bridging the wide information gap in the sector.</p>
        </div>
          ...
          <div className={styles.gradientmsg}>
            ...
            <div className={styles.weSupportAgribusinessIndustParent}>
              <b className={styles.weSupportAgribusinessContainer} data-animate-on-scroll>
                <p className={styles.agrospectrumLimitedA}>We support Agribusiness Industry</p>
                <p className={styles.agrospectrumLimitedA}>To Utilize modern Equipments</p>
                <p className={styles.agrospectrumLimitedA}>for a Better Result.</p>
              </b>
        ...
        <div className={styles.arrow}>
          <div className={styles.navRightsvgFill} onClick={onNavRightsvgFillContainerClick}>
            ...
            <img className={styles.path2Icon} alt="" src="/path-22.svg" onClick={onPath2IconClick} />
          </div>
          <b className={styles.faq}>
            <span className={styles.e}>n</span>
            <span className={styles.nhancing}>AVIGATE OUR OTHER BLOG PAGES</span>
          </b>
          <div className={styles.navRightsvgFill1}>
            <img className={styles.vectorIcon1} alt="" src="/vector19.svg" onClick={onVectorIconClick} />
            <img className={styles.path2Icon1} alt="" src="/path-23.svg" onClick={onPath2Icon2Click} />
          </div>
        </div>
      </section>
            ...
            <div className={styles.transform}>
              ...
              <div className={styles.nuncUltricesTellusWrapper}>
                <div className={styles.nuncUltricesTellusContainer}>
                  <p className={styles.agrospectrumLimitedA}>{`Transform your agricultural practices and `}</p>
                  ...
                  <div className={styles.frameParent3}>
                    ...
                    <div className={styles.agrsopectrumLtd}>
                      <span className={styles.agrsopectrumLtdTxtContainer}>
                        <span className={styles.e}>A</span>
                        <span className={styles.nhancing}>{`GRSOPECTRUM `}</span>
