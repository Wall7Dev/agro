    ...
    <div className={styles.media}>
          ...
          <div className={styles.logorightnavlink}>
            <div className={styles.logoasset}>
              <button className={styles.arrowframe}>
                <div className={styles.oursubsidiarylogos1} id="ourSubsidiaries">
                  <img className={styles.clipPathGroup} alt="" src="/clip-path-group3.svg" onClick={onClipPathGroup3Click} />
                  <img className={styles.clipPathGroup1} alt="" src="/clip-path-group7@2x.png" onClick={onClipPathGroup4Click} />
                  <img className={styles.clipPathGroup2} alt="" src="/clip-path-group8@2x.png" onClick={onClipPathGroup5Click} />
              ...
              <div className={styles.lgoframe} onClick={onLgoFrameContainer1Click}>
                <img className={styles.logoIcon} id="logo" alt="" src="/logo3@2x.png" />
              </div>
            </div>
            <nav className={styles.rightnavlink}>
              <div className={styles.homecParent}>
                <div className={styles.homec} onClick={onHomeCContainer1Click}>
                  <button className={styles.linkAbout} onClick={onLinkAboutClick}>
                    <div className={styles.linkAbout1} onClick={onLinkAbout1Click}>Home</div>
                  </button>
                  <img className={styles.homecChild} alt="" src="/line-1@2x.png" />
                </div>
                <button className={styles.aboutus} onClick={onAboutUsClick}>
                  <div className={styles.linkPricing} onClick={onLinkPricing1Click}>About Us</div>
                </button>
                <button className={styles.producAndServices} onClick={onProducAndServicesClick}>
                  <div className={styles.linkPricing} onClick={onLinkPricing12Click}>{`Product & Services`}</div>
                </button>
                <button className={styles.aboutus} onClick={onClientspartnersClick}>
                  <div className={styles.linkPricing} onClick={onLinkPricing13Click}>{`Clients & Partners`}</div>
                </button>
                <button className={styles.media1} onClick={onMediaClick}>
                  <div className={styles.linkPricing} onClick={onLinkPricing14Click}>Media</div>
              ...
              <button className={styles.contactusContainer} onClick={onContactUsContainerClick}>
                <div className={styles.contactUs} onClick={onContactUsText1Click}>Contact Us</div>
              </button>
            </nav>
          </div>
        </nav>
      ...
      <header className={styles.whyWorkWithUs}>
        <section className={styles.galleryImages}>
          <img className={styles.galleryImagesChild} alt="" src="/frame-112@2x.png" />
          <img className={styles.galleryImagesChild} alt="" src="/frame-113@2x.png" />
          <div className={styles.mrcastro} onClick={onMrCastroContainerClick}>
            <img className={styles.mrCastroAwards1} alt="" src="/mr-castro-awards-1@2x.png" />
          </div>
          <img className={styles.galleryImagesInner} alt="" src="/frame-114@2x.png" />
          <img className={styles.frameIcon} alt="" src="/frame-115@2x.png" data-animate-on-scroll />
        </section>
        <section className={styles.galleryImages1}>
          <img className={styles.galleryImagesChild1} alt="" src="/frame-1131@2x.png" />
          <img className={styles.mrCastroAwards11} alt="" src="/mr-castro-awards-11@2x.png" />
          <img className={styles.galleryImagesChild2} alt="" src="/frame-1141@2x.png" />
        </section>
        ...
        <section className={styles.teamFaqCta}>
          <div className={styles.blogNewsParent}>
            ...
            <b className={styles.learnRecentNewsContainer}>
              <p className={styles.learnRecentPractices}>Learn Recent Practices</p>
            ...
            <section className={styles.col1Parent} data-animate-on-scroll>
              <section className={styles.col1}>
                <div className={styles.frameParent} data-animate-on-scroll>
                  <div className={styles.mrCastroAwards1Parent} onClick={onFrameContainerClick}>
                    <img className={styles.mrCastroAwards12} alt="" src="/mr-castro-awards-12@2x.png" onClick={onMrCastroAwards11Click} />
                  ...
                  <div className={styles.frameWrapper} onClick={onFrameContainer1Click}>
                    <div className={styles.agrospectrumLimitedWinsTwoParent} onClick={onFrameContainer2Click}>
                      <div className={styles.agrospectrumLimitedWinsContainer}>
                        <p className={styles.learnRecentPractices}>{`Agrospectrum Limited wins two `}</p>
                        <p className={styles.learnRecentPractices}>prestigious awards</p>
                      </div>
                      <div className={styles.inTheGhanaianContainer}>
                        <p className={styles.learnRecentPractices}>In the Ghanaian space and beyond we at</p>
                        <p className={styles.agropspectrumHas}>Agropspectrum  has equipped...</p>
                      </div>
                    </div>
                  </div>
                ...
                <div className={styles.frameGroup} onClick={onFrameContainer12Click} data-animate-on-scroll>
                  <div className={styles.image3Parent}>
                    <img className={styles.image3Icon} alt="" src="/image-3@2x.png" onClick={onImage3Click} />
                  ...
                  <div className={styles.frameDiv}>
                    <div className={styles.digitalisationAGameChangerParent} onClick={onFrameContainer3Click}>
                      <div className={styles.digitalisationAGameContainer}>
                        <p className={styles.learnRecentPractices}>{`Digitalisation, A Game Changer For `}</p>
                        <p className={styles.learnRecentPractices}>Ghanaian Farmers.</p>
                      </div>
                      <div className={styles.inTheGhanaianContainer}>
                        <p className={styles.learnRecentPractices}>{`In sub-Saharan Africa, smallholder farmers `}</p>
                        <p className={styles.learnRecentPractices}>make up the largest cohort. They ....</p>
                      </div>
                    </div>
              ...
              <div className={styles.frameParent1}>
                <div className={styles.frameParent2} onClick={onFrameContainer4Click}>
                  <div className={styles.image1Parent} onClick={onFrameContainer5Click}>
                    <img className={styles.image1Icon} alt="" src="/image-1@2x.png" onClick={onImage1Click} />
                    <div className={styles.container}>
                      <div className={styles.div2}>25</div>
                      <div className={styles.dec1}>DEC</div>
                    </div>
                  </div>
                  <div className={styles.enhancingAgriculturalResilieParent} onClick={onFrameContainer13Click}>
                    <div className={styles.enhancingAgriculturalResilieContainer}>
                      <p className={styles.learnRecentPractices}>
                          <span className={styles.e}>E</span>
                        <span className={styles.nhancingAgriculturalResilien}>{`NHANCING AGRICULTURAL RESILIENCE `}</span>
                      </p>
                      <p className={styles.throughIgnitiasClimate}>THROUGH IGNITIA’S CLIMATE MONITORING.</p>
                    </div>
                    <div className={styles.inTheGhanaianContainer}>
                      <p className={styles.learnRecentPractices}>{`Agrospectrum Limited, a platform solution `}</p>
                      <p className={styles.learnRecentPractices}>{`that aggregates data of all the.... `}</p>
                    </div>
                  </div>
                ...
                <div className={styles.frameParent3} onClick={onFrameContainer14Click}>
                  <div className={styles.download6Parent}>
                    <img className={styles.download6Icon} alt="" src="/download-69@2x.png" onClick={onDownload6ImageClick} />
                    <div className={styles.frameContainer}>
                      <div className={styles.group}>
                  ...
                  <div className={styles.enhancingAgriculturalResilieParent} onClick={onFrameContainer15Click}>
                    <div className={styles.enhancingAgriculturalResilieContainer}>
                      <p className={styles.learnRecentPractices}>
                          <span className={styles.m}>M</span>
                        <span className={styles.nhancingAgriculturalResilien}>{`AY AND LOTTE INTERNATIONAL `}</span>
                      </p>
                      <p className={styles.throughIgnitiasClimate}>PARTNERS AGROSPECTRUM.</p>
                    </div>
                    <div className={styles.inTheGhanaianContainer}>
                      <p className={styles.learnRecentPractices}>{`May and Lotte International; a Ghanaian `}</p>
                      <p className={styles.learnRecentPractices}>agricultural company....</p>
                    </div>
                  </div>
              ...
              <section className={styles.frameParent4}>
                <div className={styles.frameParent5} data-animate-on-scroll>
                  <div className={styles.baseParent2}>
                    <img className={styles.baseIcon} alt="" src="/base111@2x.png" />
                    <div className={styles.vectorParent}>
                      <img className={styles.groupChild} alt="" src="/vector-17.svg" />
                      <div className={styles.div4}>25</div>
                      <div className={styles.dec3}>DEC</div>
                    </div>
                  </div>
                  <div className={styles.frameParent6}>
                    <div className={styles.agrospectrumIsRevolutionizinParent}>
                      <div className={styles.agrospectrumIsRevolutionizinContainer}>
                        <p className={styles.learnRecentPractices}>{`Agrospectrum is Revolutionizing `}</p>
                        <p className={styles.learnRecentPractices}>Agriculture Through Digital Innovation</p>
                      </div>
                ...
                <div className={styles.frameParent5} data-animate-on-scroll>
                  ...
                  <div className={styles.frameParent6}>
                    <div className={styles.agrospectrumIsRevolutionizinParent}>
                      <div className={styles.agrospectrumIsRevolutionizinContainer}>How Digitalization Connects Farmers with Global Opportunities"</div>
                      <div className={styles.digitalisationHasBeing}>Digitalisation has being a an huge ddevelopmental step ....</div>
                    </div>
                    <div className={styles.baseParent3}>
                      <div className={styles.base4} />
                      <div className={styles.byAudreyK2}>By Audrey K</div>
                ...
                <div className={styles.frameParent5} data-animate-on-scroll>
                  <div className={styles.baseParent2}>
                    <img className={styles.baseIcon} alt="" src="/base13@2x.png" />
                    <div className={styles.vectorParent}>
                      <img className={styles.groupChild} alt="" src="/vector-17.svg" />
                      <div className={styles.div4}>25</div>
                      <div className={styles.dec3}>DEC</div>
                  ...
                  <div className={styles.frameParent6}>
                    <div className={styles.agrospectrumIsRevolutionizinParent}>
                      <div className={styles.agrospectrumIsRevolutionizinContainer}>
                        <p className={styles.learnRecentPractices}>{`A Deep Dive into the Impact of `}</p>
                        <p className={styles.learnRecentPractices}>Agrospectrum on Agricultural Operations</p>
                      </div>
                      <div className={styles.digitalisationHasBeing}>Deep dive into Agrospectrum’s misson of revolutioinalizing the Agriculture industry across ....</div>
                    </div>
                    <div className={styles.baseParent3}>
                      <div className={styles.base4} />
                      <div className={styles.byAudreyK2}>By Audrey K</div>
                ...
                <div className={styles.frameParent5} data-animate-on-scroll>
                  <div className={styles.baseParent2}>
                    <img className={styles.baseIcon} alt="" src="/base14@2x.png" />
                    <div className={styles.vectorParent}>
                      <img className={styles.groupChild} alt="" src="/vector-17.svg" />
                      <div className={styles.div4}>25</div>
                      <div className={styles.dec3}>DEC</div>
                  ...
                  <div className={styles.frameParent6}>
                    <div className={styles.agrospectrumIsRevolutionizinParent}>
                      <div className={styles.agrospectrumIsRevolutionizinContainer}>
                        <p className={styles.learnRecentPractices}>{`Enhancing Agricultural Resilience Through `}</p>
                        <p className={styles.learnRecentPractices}>Ignitia's Climate Monitoring"</p>
                      </div>
                      <div className={styles.digitalisationHasBeing}>Deep dive into Agrospectrum’s misson of revolutioinalizing the Agriculture industry across ....</div>
                    </div>
                    <div className={styles.baseParent3}>
                ...
                <div className={styles.frameParent5} data-animate-on-scroll>
                  <div className={styles.baseParent2}>
                    <img className={styles.baseIcon} alt="" src="/base15@2x.png" />
                    <div className={styles.vectorParent}>
                      <img className={styles.groupChild} alt="" src="/vector-17.svg" />
                      <div className={styles.div4}>25</div>
                      <div className={styles.dec3}>DEC</div>
                  ...
                  <div className={styles.frameParent6}>
                    <div className={styles.agrospectrumIsRevolutionizinParent}>
                      <div className={styles.agrospectrumIsRevolutionizinContainer}>
                        <p className={styles.learnRecentPractices}>A Sustainable Future with Agrospectrum's</p>
                        <p className={styles.learnRecentPractices}>Environmental Impact Monitoring"</p>
                      </div>
                      <div className={styles.digitalisationHasBeing}>Deep dive into Agrospectrum’s misson of revolutioinalizing the Agriculture industry across ....</div>
                    </div>
                    <div className={styles.baseParent3}>
        ...
        <div className={styles.component1}>
          <div className={styles.frameParent15}>
            <div className={styles.download5Parent}>
              <img className={styles.download5Icon} alt="" src="/download-518@2x.png" />
              <img className={styles.download5Icon1} alt="" src="/download-519@2x.png" />
              <img className={styles.captureIcon} alt="" src="/capture9@2x.png" />
              <img className={styles.mofaColorIcon} alt="" src="/mofa-color9@2x.png" />
              <img className={styles.download3Icon} alt="" src="/download-39@2x.png" />
              <img className={styles.imagesIcon} alt="" src="/images8@2x.png" />
              <img className={styles.download6Icon1} alt="" src="/download-610@2x.png" />
              <img className={styles.download1Icon} alt="" src="/download-19@2x.png" />
              <img className={styles.downloadIcon} alt="" src="/download9@2x.png" />
              <img className={styles.images1Icon} alt="" src="/images-19@2x.png" />
              <img className={styles.download2Icon} alt="" src="/download-29@2x.png" />
            </div>
            <div className={styles.download5Group}>
              <img className={styles.download5Icon} alt="" src="/download-520@2x.png" />
              <img className={styles.download5Icon1} alt="" src="/download-521@2x.png" />
              <img className={styles.captureIcon} alt="" src="/capture10@2x.png" />
              <img className={styles.mofaColorIcon} alt="" src="/mofa-color10@2x.png" />
              <img className={styles.download3Icon} alt="" src="/download-310@2x.png" />
              <img className={styles.imagesIcon} alt="" src="/images9@2x.png" />
              <img className={styles.download6Icon1} alt="" src="/download-611@2x.png" />
              <img className={styles.download1Icon} alt="" src="/download-110@2x.png" />
              <img className={styles.downloadIcon} alt="" src="/download10@2x.png" />
              <img className={styles.images1Icon} alt="" src="/images-110@2x.png" />
              <img className={styles.download2Icon} alt="" src="/download-210@2x.png" />
            </div>
          </div>
        </div>
          ...
          <div className={styles.transformParent} id="footercontent" data-animate-on-scroll>
            <div className={styles.transform}>
              ...
              <div className={styles.nuncUltricesTellusWrapper}>
                <div className={styles.nuncUltricesTellusContainer}>
                  <p className={styles.learnRecentPractices}>{`Transform your agricultural practices and `}</p>
                  <p className={styles.learnRecentPractices}>
              ...
              <div className={styles.frameParent17}>
                <div className={styles.nowWereParent}>
                  ...
                  <div className={styles.frameParent18}>
                    ...
                    <div className={styles.nowWereGroup} onClick={onFrameContainer32Click}>
                      <div className={styles.nowWere6} onClick={onNowWereText3Click}>PARTNERS</div>
                      <img className={styles.frameChild} alt="" src="/line-19@2x.png" />
                    </div>
                  </div>
                </div>
                  ...
                  <div className={styles.frameParent20}>
                    ...
                    <div className={styles.agrsopectrumLtd}>
                      <span className={styles.agrsopectrumLtdTxtContainer}>
                        ...
                        <span className={styles.nhancingAgriculturalResilien}>{`GRSOPECTRUM `}</span>
                        <span className={styles.e}>l</span>
                        <span className={styles.nhancingAgriculturalResilien}>TD</span>
                      </span>
                    </div>
                  </div>
            ...
            <div className={styles.frameParent22}>
              <button className={styles.frameButton}>
                <img className={styles.frameItem} alt="" src="/arrow-103.svg" onClick={onArrowIconClick} />
