            ...
            <div className={styles.logoasset}>
              <button className={styles.arrowframe}>
                <div className={styles.oursubsidiarylogos} id="ourSubsidiaries">
                  ...
                  <img className={styles.clipPathGroup1} alt="" src="/clip-path-group45@2x.png" onClick={onClipPathGroup1Click} />
                  <img className={styles.clipPathGroup2} alt="" src="/clip-path-group46@2x.png" onClick={onClipPathGroup2Click} />
                  <img className={styles.oursubsidiarylogosChild} alt="" src="/group-93911.svg" />
                </div>
                <img className={styles.images21} alt="" src="/images-2-116@2x.png" />
              </button>
              <div className={styles.lgoframe} onClick={onLgoFrameContainerClick}>
                <img className={styles.logoIcon} id="logo" alt="" src="/logo16@2x.png" />
              </div>
            </div>
      ...
      <header className={styles.careersInner}>
        <div className={styles.careersParent}>
          <div className={styles.careers1} data-animate-on-scroll>
            <h1 className={styles.careers2} data-animate-on-scroll>Careers</h1>
          </div>
        ...
        <div className={styles.desktopMakeEnquiry}>
          <section className={styles.frameParent}>
            ...
            <div className={styles.frameGroup}>
              <div className={styles.careersWrapper}>
                <h5 className={styles.careers3} data-animate-on-scroll>CAREERS</h5>
              </div>
              <p className={styles.ourInnovativeGroupBelievesWrapper} data-animate-on-scroll>
                <div className={styles.ourInnovativeGroup}>Our innovative group believes in the value and talent in team work. Join the ever growing team of creative minds and talents. Browse through our available positions or send an open application by attaching your CV</div>
              </p>
            </div>
          </section>
          <div className={styles.contactForm}>
            ...
            <div className={styles.frameDiv}>
              <input className={styles.frameChild} placeholder="Choose file" type="text" />
              <input className={styles.noFileChosen} placeholder="No file chosen" type="text" />
            </div>
            <input className={styles.frameInput} placeholder="Type your message here" type="text" />
        ...
        <div className={styles.component1}>
          <div className={styles.frameParent1}>
            <div className={styles.download5Parent}>
              <img className={styles.download5Icon} alt="" src="/download-5221@2x.png" />
              <img className={styles.download5Icon1} alt="" src="/download-5231@2x.png" />
              <img className={styles.captureIcon} alt="" src="/capture111@2x.png" />
              <img className={styles.mofaColorIcon} alt="" src="/mofa-color111@2x.png" />
              <img className={styles.download3Icon} alt="" src="/download-3111@2x.png" />
              <img className={styles.imagesIcon} alt="" src="/images101@2x.png" />
              <img className={styles.download6Icon} alt="" src="/download-6121@2x.png" />
              <img className={styles.download1Icon} alt="" src="/download-1111@2x.png" />
              <img className={styles.downloadIcon} alt="" src="/download111@2x.png" />
              <img className={styles.images1Icon} alt="" src="/images-1111@2x.png" />
              <img className={styles.download2Icon} alt="" src="/download-2111@2x.png" />
            </div>
            <div className={styles.download5Group}>
              <img className={styles.download5Icon} alt="" src="/download-5241@2x.png" />
              <img className={styles.download5Icon1} alt="" src="/download-5251@2x.png" />
              <img className={styles.captureIcon} alt="" src="/capture121@2x.png" />
              <img className={styles.mofaColorIcon} alt="" src="/mofa-color121@2x.png" />
              <img className={styles.download3Icon} alt="" src="/download-3121@2x.png" />
              <img className={styles.imagesIcon} alt="" src="/images111@2x.png" />
              <img className={styles.download6Icon} alt="" src="/download-6131@2x.png" />
              <img className={styles.download1Icon} alt="" src="/download-1121@2x.png" />
              <img className={styles.downloadIcon} alt="" src="/download121@2x.png" />
              <img className={styles.images1Icon} alt="" src="/images-1121@2x.png" />
              <img className={styles.download2Icon} alt="" src="/download-2121@2x.png" />
            </div>
          </div>
        </div>
        <footer className={styles.footer}>
          <div className={styles.transformParent} id="footercontent" data-animate-on-scroll>
            <div className={styles.transform}>
              ...
              <button className={styles.getInTouchWrapper} onClick={onFrameButton1Click}>
                ...
                <div className={styles.nowWereParent}>
                  ...
                  <div className={styles.frameParent4}>
                    ...
                    <div className={styles.nowWereGroup} onClick={onFrameContainer3Click}>
                      ...
                      <img className={styles.frameItem} alt="" src="/line-113@2x.png" />
                    </div>
                  </div>
                </div>
            ...
            <div className={styles.frameParent8}>
              <button className={styles.vectorParent}>
                <img className={styles.frameInner} alt="" src="/arrow-10.svg" onClick={onArrowIconClick} />
