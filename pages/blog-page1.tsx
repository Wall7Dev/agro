            ...
            <div className={styles.logoasset}>
              <button className={styles.arrowframe}>
                <div className={styles.oursubsidiarylogos} id="ourSubsidiaries">
                  ...
                  <img className={styles.clipPathGroup2} alt="" src="/clip-path-group@2x.png" onClick={onClipPathGroup2Click} />
              ...
              <div className={styles.lgoframe} onClick={onLgoFrameContainerClick}>
                <img className={styles.logoIcon} id="logo" alt="" src="/logo9@2x.png" />
              </div>
            </div>
      ...
      <section className={styles.section6partners}>
        ...
        <div className={styles.digitalisationAGameChangerParent}>
          <div className={styles.digitalisationAGameContainer}>
            ...
            <span className={styles.igitalisationAGame}>{`igitalisation, A Game Changer For `}</span>
            <span className={styles.d}>G</span>
            <span className={styles.igitalisationAGame}>hanaian Farmers.</span>
          </div>
        ...
        <div className={styles.inSubSaharanAfricaContainer}>
          <p className={styles.inSubSaharanAfrica}>In sub-Saharan Africa, smallholder farmers make up the largest cohort. They occupy a much larger share of land in sub-Saharan Africa than the global average. In Ghana, about 45% of our workforce is employed in Agriculture with the largest group being smallholder farmers. This group of farmers contributes about 80% of the food produced in Ghana. Hence promoting food security in the West African country.  </p>
          <p className={styles.blankLine}>&nbsp;</p>
          <p className={styles.blankLine}>Albeit the commendable feat these smallholder farmers attained. Their industry is still saddled with numerous complexities and challenges. Some of such challenges include access to markets, lack of information, inadequate finances and infrastructure. Digitalization can help farmers and industry players overcome these challenges by connecting farmers to global opportunities. </p>
          <p className={styles.blankLine}>Agrospectrum Ghana Limited, a Ghanaian AgTech business is at the forefront of this digital revolution. By leveraging technology, Agrospectrum Limited is helping farmers in Ghana access global markets and financing by way of inputs and resources; </p>
          <p className={styles.blankLine}>&nbsp;</p>
          <p className={styles.blankLine}>
              <b className={styles.accessToMarketplaces}>Access to Marketplaces:</b>
            <span className={styles.agrospectrumLimitedUses}> Agrospectrum Limited uses its data collection framework as a focal point to provide farmers with inclusion and also open them up to global markets. The platform serves as a marketplace where all members in the Agric sector can transact. The cocktail of solutions provided by Agrospectrum like the Agronomic and climate-smart information, and extension services which include monitoring ensure that farmers have their produce meeting local and foreign specifications. Thus, giving them eligibility for certification to European and American Markets for export.  </span>
          </p>
          <p className={styles.blankLine}>&nbsp;</p>
          <p className={styles.blankLine}>
              <b className={styles.accessToMarketplaces}>{`Access to Information: `}</b>
            <span>Digitalization can help farmers access real-time information about weather, markets, and crop management. This can help farmers make informed decisions and improve their yields. The Agrospectrum suite includes the Climate-smart Agric product, which is deployed through SMS and Interactive voice response (IVR) and call centers in numerous local languages to farmers. Now farmers can get access to data that will help them make accurate planting, harvesting, and irrigation decisions enhancing their yield quality and cutting down on crop losses. Thus, bridging the information divide in the agricultural sector.</span>
          </p>
        </div>
        <img className={styles.image2Icon} alt="" src="/image-3@2x.png" />
        <div className={styles.inSubSaharanAfricaContainer}>
          <p className={styles.blankLine}>
              <b className={styles.accessToMarketplaces}>Improved Traceability:</b>
            <span> Digitalization can help farmers track their products from farm to market. This can help improve food safety and quality. Agrospectrum with its extension services offered as part of the Climate Smart Agric, allows for extensive monitoring of farmers and regular checks to ensure that they follow the accepted agronomic procedures from the planting to harvesting stage this ensures that the commodities produced are of the highest quality. As a data-oriented entity, Agrospectrum ensures that each bag of produce sold can be tracked and traced to the farmer who produced it. </span>
          </p>
          <p className={styles.blankLine}>&nbsp;</p>
          <p className={styles.blankLine}>
          ...
          <p className={styles.blankLine}>&nbsp;</p>
          <p className={styles.blankLine}>{`Agrospectrum aims to change the nature of credit offered to farmers by onboarding financial institutions and aggregators onto their platforms. Agrospectrum ensures that farmers registered on our platform get inclusion in these programs being run by collecting requisite and salient information including biometrics to ensure that investors are confident in the use of their credit. `}</p>
          <p className={styles.blankLine}>&nbsp;</p>
          <p className={styles.inSubSaharanAfrica}>Agrospectrum acts as a marketplace that offers enough documentation for all actors in the value chain to transact in a risk-free environment.  </p>
          <p className={styles.blankLine}>Digitalization is transforming agriculture in Ghana and connecting farmers with global opportunities. Agrospectrum Limited is playing a key role in this transformation by providing farmers with access to online marketplaces, weather data, and crop management information. By leveraging technology, Agrospectrum Limited is helping farmers in Ghana overcome the challenges they face and improve their livelihoods. </p>
          <p className={styles.blankLine}> </p>
          <p className={styles.blankLine}>Media Contact: </p>
          <p className={styles.audreyAmaOduro}>Audrey Ama Oduro </p>
          <p className={styles.blankLine}>
        ...
        <div className={styles.gradientmsgWrapper}>
          <div className={styles.gradientmsg}>
            <img className={styles.gradientmsgChild} alt="" src="/group-206@2x.png" />
            <div className={styles.weSupportAgribusinessIndustParent}>
              <b className={styles.weSupportAgribusinessContainer} data-animate-on-scroll>
                <p className={styles.blankLine}>We support Agribusiness Industry</p>
              ...
              <div className={styles.vectorParent} onClick={onFrameContainerClick}>
                <img className={styles.frameChild} alt="" src="/arrow-9@2x.png" />
        ...
        <div className={styles.arrow}>
          <div className={styles.navRightsvgFill} onClick={onNavRightsvgFillContainerClick}>
            <img className={styles.vectorIcon} alt="" src="/vector20.svg" />
            <img className={styles.path2Icon} alt="" src="/path-24.svg" onClick={onPath2IconClick} />
          </div>
          <b className={styles.faq}>
            <span className={styles.d}>n</span>
            <span className={styles.igitalisationAGame}>AVIGATE OUR OTHER BLOG PAGES</span>
          </b>
          <div className={styles.navRightsvgFill1} onClick={onNavRightsvgFillContainer1Click}>
            <img className={styles.vectorIcon1} alt="" src="/vector21.svg" />
            <img className={styles.path2Icon1} alt="" src="/path-21.svg" onClick={onPath2Icon2Click} />
          </div>
        </div>
      </section>
          ...
          <div className={styles.transformParent} id="footercontent" data-animate-on-scroll>
            <div className={styles.transform}>
              ...
              <div className={styles.nuncUltricesTellusWrapper}>
                <div className={styles.nuncUltricesTellusContainer}>
                  <p className={styles.blankLine}>{`Transform your agricultural practices and `}</p>
                  <p className={styles.blankLine}>
                      <span className={styles.accessToMarketplaces}>cultivate success with</span>
                        <b className={styles.accessToMarketplaces}> industry's best</b>
                    <span>—empowering farmers, streamlining operations,</span>
                  </p>
                  <p className={styles.blankLine}>
                    <span>{`and fostering a connected `}</span>
                      <b className={styles.accessToMarketplaces}>global community</b>
                  </p>
                </div>
              </div>
                ...
                <div className={styles.nowWereParent}>
                  ...
                  <div className={styles.frameParent1}>
                    ...
                    <div className={styles.nowWereGroup} onClick={onFrameContainer3Click}>
                      ...
                      <img className={styles.frameItem} alt="" src="/line-1@2x.png" />
                    </div>
                  </div>
                </div>
                  ...
                  <div className={styles.frameParent3}>
                    ...
                    <div className={styles.agrsopectrumLtd}>
                      <span className={styles.agrsopectrumLtdTxtContainer}>
                        ...
                        <span className={styles.igitalisationAGame}>{`GRSOPECTRUM `}</span>
            ...
            <div className={styles.frameParent5}>
              <button className={styles.vectorGroup}>
                <img className={styles.frameInner} alt="" src="/arrow-104.svg" onClick={onArrowIconClick} />
