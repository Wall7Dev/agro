    ...
    <section className={styles.leadersections}>
      <div className={styles.leadershipteamParent}>
        <div className={styles.leadershipteam} data-animate-on-scroll>
          <h1 className={styles.leadershipTeam} data-animate-on-scroll>Leadership Team</h1>
        </div>
        <div className={styles.cardCaurosol}>
          <div className={styles.card1}>
                    ...
                    <div className={styles.block1Parent}>
                      ...
                      <div className={styles.frameParent}>
                        <div className={styles.razakAwudulaiContainer}>
                          <div className={styles.razakAwudulai1}>Razak Awudulai</div>
                        </div>
            ...
            <div className={styles.razakIsAn} data-animate-on-scroll>{`Razak is an accomplished business leader with 20+ years of experience in creating enabling environments and building high-performance teams. He is passionate about the technology ecosystem and has helped to grow many tech businesses both in the public and private sectors globally. More specifically, `}</div>
          </div>
          <div className={styles.card1}>
            <div className={styles.castroDansoTeamWrapper} data-animate-on-scroll>
            ...
            <div className={styles.nanaHas20} data-animate-on-scroll>{`Nana has 20+ years of local and international expertise in banking in various management roles across several countries in Africa and the UK. Nana has successfully led the team in significantly growing market share and profitability across the Bank’s Personal and Business Banking franchises. In January 2021, Nana was appointed Managing Director of UMB Bank. `}</div>
          </div>
        </div>
        <button className={styles.getInTouchWrapper} onClick={onFrameButtonClick} data-animate-on-scroll>
          <div className={styles.getInTouch} onClick={onGETINTOUCHClick}>See Full Team</div>
        </button>
