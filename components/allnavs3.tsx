...
import styles from "./allnavs3.module.css";

const Allnavs3: NextPage = () => {
            ...
            <div className={styles.logoasset1}>
              <button className={styles.arrowframe1}>
                <div className={styles.oursubsidiarylogos} id="ourSubsidiaries">
                  ...
                  />
                  <img
                    className={styles.oursubsidiarylogosItem}
                    alt=""
                    src="/group-9396.svg"
                  />
                </div>
