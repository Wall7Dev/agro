  ...
  return (
    <button className={styles.arrowframe}>
      <div className={styles.oursubsiadiries}>
        ...
        <img className={styles.bdp1Icon} alt="" src="/bdp-1@2x.png" onClick={onBdp1ImageClick} />
        <img className={styles.spectrum1Icon} alt="" src="/spectrum-1@2x.png" onClick={onSpectrum1ImageClick} />
        <img className={styles.isg1Icon} alt="" src="/isg-1@2x.png" onClick={onIsg1ImageClick} />
      </div>
    </button>);
};
