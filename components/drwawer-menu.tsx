    ...
    <div className={styles.drwawerMenu} data-animate-on-scroll>
      <div className={styles.frameParent}>
        <div className={styles.logoassetParent}>
          <div className={styles.logoasset}>
            <button className={styles.lgoframe} onClick={onLgoFrameClick}>
              <img className={styles.logoIcon} id="logo" alt="" src="/logo10@2x.png" />
            </button>
            <button className={styles.arrowframe}>
              <div className={styles.oursubsiadiries}>
                <img className={styles.oursubsiadiriesChild} alt="" src="/group-939111.svg" />
                <img className={styles.bdp1Icon} alt="" src="/bdp-11@2x.png" onClick={onClose} />
                <img className={styles.spectrum1Icon} alt="" src="/spectrum-11@2x.png" onClick={onClose} />
                <img className={styles.isg1Icon} alt="" src="/isg-11@2x.png" onClick={onClose} />
              </div>
              <img className={styles.images21} alt="" src="/images-2-12@2x.png" />
            </button>
          </div>
        ...
        <div className={styles.homeParent}>
          ...
          <button className={styles.home} onClick={onAboutUsClick}>About Us</button>
          <button className={styles.home} onClick={onProductsSevicesClick}>{`Products & Sevices`}</button>
          <button className={styles.home} onClick={onClientsPartnersClick}>{`Clients & Partners`}</button>
          <button className={styles.home} onClick={onMediaClick}>Media</button>
          <button className={styles.home} onClick={onCareersClick}>Careers</button>
        </div>
        ...
        <div className={styles.frameGroup}>
          ...
          <div className={styles.bdp1Parent}>
            <img className={styles.bdp1Icon} alt="" src="/bdp-12@2x.png" onClick={onClose} />
            <img className={styles.spectrum1Icon} alt="" src="/spectrum-12@2x.png" onClick={onClose} />
            <img className={styles.isg1Icon} alt="" src="/isg-12@2x.png" onClick={onClose} />
            <img className={styles.bslMain6Icon} alt="" src="/bslmain-6@2x.png" onClick={onClose} />
          </div>
        </div>
      </div>
    </div>);
