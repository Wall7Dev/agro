  ...
  return (
    <div className={styles.footerComponent}>
      ...
      <footer className={styles.footer}>
        <div className={styles.transformParent} id="footercontent" data-animate-on-scroll><Transform onFramesWithTextClick={onFrameButtonClick} /><FooterFrames1 /><FooterFrames propTop="-23.79%" onArrowIconClick={onArrowIconClick} onNowWereText19Click={onNowWereTextClick} />
        </div>
      </footer>
