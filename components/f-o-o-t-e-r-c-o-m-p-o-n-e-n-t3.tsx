    ...
    <div className={styles.footerComponent}>
      <div className={styles.logoAutoscrollframe}>
        <div className={styles.dsktopBanner2}>
          ...
          />
          <img className={styles.captureIcon} alt="" src="/capture13@2x.png" />
          <img
        ...
        <section className={styles.dsktopBanner1}>
          ...
          />
          <img className={styles.captureIcon1} alt="" src="/capture14@2x.png" />
          <img
            className={styles.mofaColorIcon1}
            alt=""
            src="/mofa-color14@2x.png"
          />
          <img className={styles.imagesIcon1} alt="" src="/images12@2x.png" />
          <img
