      ...
      <div className={styles.ladycard}>
        <div className={styles.frameParent}>
          <div className={styles.aggregationParent}>
            ...
            <div className={styles.theAggregationModule}>The Aggregation module looks at ensuring convenience in the produce aggregation process. It allows aggregators to purchase produce from both Farmers and community aggregators at the market rate. The module uses an internet- of things (IOT) system.</div>
            <div className={styles.theAggregationModule}>{`Thus it is integrated with hardware components to ensure that both the quality and quantity meets the right pricing. This solution is linked to the Broadspectrum digital payments platform which is integrated with Telco’s to facilitate the payments been made to the farmers. `}</div>
          </div>
