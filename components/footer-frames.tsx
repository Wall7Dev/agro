...
const FooterFrames:NextPage<FooterFramesType> = ({ propTop, onArrowIconClick, onNowWereText19Click }) => {
  ...
  const onGroupIconClick = useCallback(() => {
    window.location.href = "https://www.instagram.com/agrospectrumgh?igsh=NzBmMjdhZWRiYQ==";
  }, []);
  ...
  return (
    <div className={styles.frameParent}>
      <button className={styles.vectorParent}>
        <img className={styles.frameChild} alt="" src="/arrow-105.svg" onClick={onArrowIconClick} />
        <div className={styles.nowWere} onClick={onNowWereText19Click}>GET DIRECTION</div>
      </button>
      <div className={styles.nowWereParent}>
        <div className={styles.nowWere1}>
          <div className={styles.nowWere2}>PHONE</div>
        </div>
        <div className={styles.nowWere3} onClick={onNowWereTextClick}>+233(0) 593 808 064</div>
      </div>
      <div className={styles.nowWereGroup}>
        <div className={styles.nowWere4}>
          <div className={styles.nowWere5} style={nowWereStyle}>EMAIL</div>
        </div>
      ...
      <div className={styles.nowWereContainer}>
        ...
        <div className={styles.instagramParent}>
          <div className={styles.instagram} onClick={onInstagramContainerClick}>
            <img className={styles.groupIcon} alt="" src="/group61.svg" onClick={onGroupIconClick} />
          </div>
          ...
          <div className={styles.linkedinAgrospectrem} onClick={onLinkedinAgrospectremContainerClick}>
            <img className={styles.vectorIcon2} alt="" src="/vector24.svg" onClick={onVectorIconClick} />
          </div>
        </div>
      </div>
    </div>);
