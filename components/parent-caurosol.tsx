  ...
  return (
    <div className={styles.parentCaurosol}>
      <section className={styles.mission}>
        <div className={styles.missionInner} onClick={onFrameContainerClick} data-animate-on-scroll>
      ...
      <section className={styles.section2}>
        ...
        <div className={styles.weOfferAContainer}>
          <p className={styles.weOfferA}>We offer a huge arsenal of logistics and expertise to</p>
          <p className={styles.weOfferA}>strategize and tackle most agro challenges</p>
        </div>
      </section>
    </div>);
};
